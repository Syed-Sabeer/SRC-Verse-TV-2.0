...
$selectMovies = "SELECT * FROM `movies` LIMIT $offset, $itemsPerPage";
$moviedetail = mysqli_query($con, $selectMovies);
...
$selectMovies = "SELECT * FROM `movies` WHERE title LIKE '%$searchTerm%' LIMIT $offset, $itemsPerPage";
$moviedetail = mysqli_query($con, $selectMovies);
                        ...
                        <div class="table-responsive">
							...
							while ($catalog = mysqli_fetch_assoc($moviedetail)) {
								...
								<tr>
									...
									<td>
										<div class="catalog__text">'.$catalog['runtime'].'</div>
									</td>
									<td>
										<div class="catalog__text ">'.$catalog['release_year'].'</div>
									</td>
									<td>
									<img class="catalog__text" src="../utilities/images/poster/'.$catalog['poster_img'].'" alt="" height="100px" width="80px">
									</td>
									<td>
										<div class="catalog__btns">
											
											<a href="update-movie.php?updateid='.$catalog['id'].'" class="catalog__btn catalog__btn--edit">
